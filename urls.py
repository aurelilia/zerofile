...
urlpatterns = [
    ...
    path('s/', include('zerofile.streamer.urls')),
    path('login/', auth_views.LoginView.as_view(), name='login'),
    path('logout/', auth_views.LogoutView.as_view(template_name='uploader/index.html'), name='logout'),
